 ...
 * @subpackage	Template
 */
class Dwoo_Plugin_restrict extends Dwoo_Block_Plugin implements Dwoo_ICompilable_Block, Dwoo_IElseable {
	...
	public static function postProcessing(Dwoo_Compiler $compiler, array $params, $prepend, $append, $content) {
		...
		$pre	= Dwoo_Compiler::PHP_OPEN.'if( TodoyuRightsManager::isAllowed(' . $params[0] . ',' . $params[1] . ") ) {".Dwoo_Compiler::PHP_CLOSE;
